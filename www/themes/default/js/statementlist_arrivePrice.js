/**
 * Created by will_zhang on 1/9/2017.
 */
...
loadScript('js/hui/jquery.hui.grid.js', function () {
    $('#shipmentTbl').grid({
        "aoColumns" : [
            ...
            {sTitle: "中标价", sName: "price","bSortable": false},
        ],
        "fnServerData" : function(sSource, aoData, fnCallback) {
            var searchParams = genSearchParams();
            $ips.gridLoadData(sSource, aoData, fnCallback, "statementlist", "getArriveList", searchParams, function(data) {
...
loadScript('js/hui/jquery.hui.exportdata.js', function () {
    ...
    $('#export').exportdata({dataModule : 'statementlist',dataMethod:'getArriveList',searchParams: exportSearchParams,title:'到站中标价分析报表',partDataRows:3000,partSize:100});
},true,true);
