/**
 * Created by will_zhang on 1/12/2017.
 */
...
loadScript('js/hui/jquery.hui.grid.js', function () {
    $('#shipmentTbl').grid({
        "aoColumns" : [
            ...
            {sTitle: "是否异常签收", sName: "is_error_checkout","bSortable": false},
        ],
...
loadScript('js/hui/jquery.hui.exportdata.js', function () {
    ...
    $('#export').on('click', function(){
        ...
        exportSearchParams.push({name:"is_checkout","value":true});
    });
    exportSearchParams.push({name:"filename","value":"print-" + time});
    $('#export').exportdata({dataModule : 'statementlist',dataMethod:'getReceiptList',searchParams: exportSearchParams,title:'电子签收明细报表',partDataRows:3000,partSize:100});
},true,true);
