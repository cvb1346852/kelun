...
loadScript('js/hui/jquery.hui.grid.js', function () {
    $('#shipmentTbl').grid({
        "aoColumns" : [
            ...
            {sTitle: "合同时间", sName: "create_time","bSortable": true},
            {sTitle: "起止时间", sName: "start_time","bSortable": false},
        ],
        "fnServerData" : function(sSource, aoData, fnCallback) {
            var searchParams = genSearchParams();
            $ips.gridLoadData(sSource, aoData, fnCallback, "statementlist", "getReportList", searchParams, function(data) {
...
loadScript('js/hui/jquery.hui.exportdata.js', function () {
    ...
    $('#export').exportdata({dataModule : 'statementlist',dataMethod:'getReportList',searchParams: exportSearchParams,title:'固定运价合同提醒报表',partDataRows:3000,partSize:100});
},true,true);
