...
RESOURCEURL = getBaseUrl('resourceurl',
    'http://'+window.location.host+'/inside.php?t=json&m=index&f=getResourceUrl');
UCENTERURL = getBaseUrl('ucenterurl',
    'http://'+window.location.host+'/inside.php?t=json&m=index&f=getUcenterUrl');
var resourceFiles = [
...
loadFile(window.location.origin + '/js/poshytip/jquery.poshytip.js');
var initCss = [
